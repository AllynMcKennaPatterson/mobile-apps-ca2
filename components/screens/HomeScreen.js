...
const HomeScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.button} onPress={() => navigation.navigate('DeleteProduct')}>
        <Text style={styles.buttonText}>Delete a Product</Text>
      </Pressable>
      <Pressable style={styles.button} onPress={() => navigation.navigate('UpdateProduct')}>
        <Text style={styles.buttonText}>Update a Product ID</Text>
      </Pressable>
    </View>
  )
}
